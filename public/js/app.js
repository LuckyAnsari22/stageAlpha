...
.when('/admin', { redirectTo: '/admin/dashboard' })
    .when('/admin/diagnostic', { templateUrl: '/views/admin-diagnostic.html', controller: 'AdminDiagnosticCtrl', title: 'Diagnostics', requireAdmin: true })
    ...
    .when('/admin/customers', { templateUrl: '/views/admin-customers.html', controller: 'AdminCustomersCtrl', title: 'Customers', requireAdmin: true })
    .when('/admin/reports', { templateUrl: '/views/admin-reports.html', controller: 'AdminReportsCtrl', title: 'Reports', requireAdmin: true })
    ...
    .when('/admin/intelligence', { templateUrl: '/views/admin-intelligence.html', controller: 'AdminIntelligenceCtrl', title: 'Intelligence', requireAdmin: true })
